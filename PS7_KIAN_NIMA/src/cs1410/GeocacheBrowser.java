...
public class GeocacheBrowser extends JFrame
{
    ...
    {
        // Create a GeocacheBrowser
        SwingUtilities.invokeLater( () -> new GeocacheBrowser());
    }
    ...
    public GeocacheBrowser ()
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Error when reading cache file " + cacheFile);
            System.exit(-1);
        }
...
class SearchPane extends JPanel implements ActionListener, ItemListener, DocumentListener
{
    ...
    /**
     * This method is called when one of the controls is manipulated. We notify the cache list of the change and then
     * update the list of current caches.
     */
    ...
    private void update ()
    {
        ...
        allCaches.setDifficultyConstraints(Double.parseDouble((String) lowDiff.getSelectedItem()),
                Double.parseDouble((String) highDiff.getSelectedItem()));
        allCaches.setTerrainConstraints(Double.parseDouble((String) lowTerr.getSelectedItem()),
